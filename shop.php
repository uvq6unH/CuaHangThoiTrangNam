...
<head>
    ...
    <title>Male Fashion | Cửa Hàng</title>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__left">
                                    <p>Hiển thị <?php echo min($itemsPerPage, $totalProducts - $offset); ?> Trên <?php echo $totalProducts; ?> Kết Quả</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__right">
                                    <form method="GET">
                                        ...
                                        <select name="sort" onchange="this.form.submit()">
                                            <option value="high-low" <?php echo $sortOption == 'high-low' ? 'selected' : ''; ?>>Cao Đến Thấp</option>
                                            <option value="low-high" <?php echo $sortOption == 'low-high' ? 'selected' : ''; ?>>Thấp Đến Cao</option>
                                        </select>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div id="product-results" class="row">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<li><a href='#'><img src='img/icon/compare.png' alt=''> <span>So Sánh</span></a></li>";
                                echo "<li><a href='#'><img src='img/icon/search.png' alt=''></a></li>";
                                echo "</ul>";
                                echo "</div>";
                                echo "<div class='product__item__text'>";
                                echo "<h6>" . $row["NAME"] . "</h6>";
                                echo "<a href='#' class='add-cart' data-product-id='$productId' data-quantity='1'>+ Thêm Vào Giỏ</a>";
