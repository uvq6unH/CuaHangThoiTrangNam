            ...
            <div class="row">
                                    ...
                                    <?php foreach ($cartItems as $item): ?>
                                        <tr>
                                            ...
                                            <td class="cart__close">
                                                <a href="remove-from-cart.php?id=<?php echo $item['ID']; ?>" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này chứ?');">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="continue__btn update__btn">
                                <a href="shopping-cart.php"><i class="fa fa-spinner"></i> Cập nhật giỏ</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="cart__total">
                        <h6>Tổng Tiền</h6>
                        <ul>
                            <li>Thành Tiền <span>$ <?= number_format($total, 2) ?></span></li>
                            <?php if (isset($_SESSION['discount'])): ?>
                                ...
                                ?>
                                <li>Giảm Giá (<?= $discountPercentage ?>%) <span>-$ <?= number_format($discountAmount, 2) ?></span></li>
                                <li>Tổng Tiền <span>$ <?= number_format($totalAfterDiscount, 2) ?></span></li>
                            <?php else: ?>
                                <li>Tổng Tiền <span>$ <?= number_format($total, 2) ?></span></li>
                            <?php endif; ?>
                        </ul>
                        <a href="checkout.php" id="checkout-btn" class="primary-btn">Thanh Toán</a>
                    </div>
                </div>
            </div>
        </div>
