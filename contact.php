...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO feedback (IDUSER, NAME, EMAIL, MESSAGE) VALUES (?, ?, ?, ?)";
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__text">
                        <div class="section-title">
                            <span>Thông tin</span>
                            <h2>Liên hệ</h2>
                            <p>Công ty thời trang nam chuyên cung cấp trang phục chất lượng, phong cách đa dạng, giá cả hợp lý.</p>
                        </div>
                        <ul>
                            <li>
                                <h4>Hai Ba Trung</h4>
