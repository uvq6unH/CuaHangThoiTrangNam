                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul class="checkout__total__all">
                                    <li>Thành Tiền <span>$<?php echo number_format($totalAmount, 2); ?></span></li>
                                    <?php
                                    if (isset($_SESSION['discount'])) {
                                        $discountPercentage = $_SESSION['discount'];
                                        $discountAmount = ($totalAmount * $discountPercentage) / 100;
                                        $totalAfterDiscount = $totalAmount - $discountAmount;
                                        echo "<li>Giảm Giá ({$discountPercentage}%) <span>-$" . number_format($discountAmount, 2) . "</span></li>";
                                        echo "<li>Tổng Tiền <span>$" . number_format($totalAfterDiscount, 2) . "</span></li>";
                                    } else {
                                        echo "<li>Tổng Tiền <span>$" . number_format($totalAmount, 2) . "</span></li>";
                                    }
                                    ?>
                                </ul>

                                <button type="button" class="site-btn" data-toggle="modal" data-target="#placeOrderModal" onclick="populateModal()">Thanh Toán</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <section class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="placeOrderLabel">Chi Tiết Hóa Đơn</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="paymentMethod">Chọn Phương Thức Thanh Toán<span>*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="transportMethod">Chọn Phương Thức Vận Chuyển<span>*</span></label>
