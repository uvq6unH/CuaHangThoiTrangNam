...
INSERT INTO `feedback` (`ID`, `IDUSER`, `NAME`, `EMAIL`, `MESSAGE`) VALUES
(1, 1, 'Nguyễn Tuấn Hưng', 'xenonex04@gmail.com', 'gud'),
(5, 2, 'anh huy beo', 'anhhuyhoibeo@gmail.com', 'shop ship hang con cham'),
(6, 3, 'may troem kim nguu', 'ninh@gmail.com', 'Hàng đẹp nhưng ít hàng!!!');
...
(133, 1, 1, '2024-11-30 02:39:41', 3, 391000, 'done', 'Nguyễn Dương Ninh', 'Kim Ngưu, Hà Nội', '0123456789'),
(135, 2, 1, '2024-11-30 02:45:31', 3, 1513, 'done', 'Nguyễn Dương Ninh', 'Kim Ngưu, Hà Nội', '0123456789');
