...
include('../auth.php');
include('../db.php');
$query = "SELECT SUM(TOTAL_MONEY) AS total_month 
          FROM orders 
          WHERE MONTH(ORDERS_DATE) = MONTH(CURRENT_DATE()) 
          AND YEAR(ORDERS_DATE) = YEAR(CURRENT_DATE())";
$result = $conn->query($query);

$totalMonthly = 0;
if ($result) {
    $row = $result->fetch_assoc();
    $totalMonthly = $row['total_month'] ?? 0;
}
$query = "SELECT SUM(TOTAL_MONEY) AS total_year 
          FROM orders 
          WHERE YEAR(ORDERS_DATE) = YEAR(CURRENT_DATE())";
$result = $conn->query($query);

$totalYearly = 0;
if ($result) {
    $row = $result->fetch_assoc();
    $totalYearly = $row['total_year'] ?? 0;
}
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> In Thống Kê</a>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                $ <?php echo number_format($totalMonthly, 0, '.', ','); ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Tổng Tiền (Năm)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                $ <?php echo number_format($totalYearly, 0, '.', ','); ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
